				...
				<div class="card-body">
					<form action="<?php echo site_url('Kelamin/ubah'); ?>" method="post">
						<div class="form-group">
							...
							<input type="text" name="nama" class="form-control" placeholder="Nama Jenis Kelamin" value="<?php echo $kelamin->nama_jenkel; ?>">
						</div>

						<input type="hidden" name="id_jenkel" value="<?php echo $kelamin->id_jenkel; ?>">
