							...
							<div class="col-md-12">
								<table class="table table-responsive">
									...
									<tr>
										...
										<td><input type="number" max="1" min="1" class="form-control" name="<?php echo 'ibadahSB-'.$item->NISN; ?>"></td>
										<td><input type="number" max="1" min="1" class="form-control" name="<?php echo 'ibadahPB-'.$item->NISN; ?>"></td>
										<td><input type="number" max="1" min="1" class="form-control" name="<?php echo 'syukurSB-'.$item->NISN; ?>"></td>
										<td><input type="number" max="1" min="1" class="form-control" name="<?php echo 'syukurPB-'.$item->NISN; ?>"></td>
										<td><input type="number" max="1" min="1" class="form-control" name="<?php echo 'doaSB-'.$item->NISN; ?>"></td>
										<td><input type="number" max="1" min="1" class="form-control" name="<?php echo 'doaPB-'.$item->NISN; ?>"></td><td><input type="number" max="1" min="1" class="form-control" name="<?php echo 'toleransiSB-'.$item->NISN; ?>"></td>
										<td><input type="number" max="1" min="1" class="form-control" name="<?php echo 'toleransiPB-'.$item->NISN; ?>"></td>
									</tr>
									<?php } ?>
								</table>
							</div>
