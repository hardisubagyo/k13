	...
	public function simpan(){
		...
		foreach($getSiswa as $siswa) {
			foreach($getKD as $kd){
				...
				$this->db->query("INSERT INTO tr_nilai_matpel (NISN,id_matpel,id_kd,nilai,id_tingkat,id_tahunajaran,semester,id_jenis_kd) VALUES('".$siswa->NISN."','".$id_matpel."','".$kd->id_kd."','".$nilai."','".$id_tingkat."','".$tahunajaran."','".$semester."','".$id_jenis_kd."')");
			}
